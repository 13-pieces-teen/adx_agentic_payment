...
umask 077
{
  ...
  printf 'ADX_ARENA402_G_TOKEN_ADDRESS=\n'
  ...
  printf 'ADX_CURRENT_GAME_ROUND_COUNT=5\n'
  printf 'ADX_CURRENT_GAME_START_THRESHOLD=10\n'
  printf 'ADX_CURRENT_GAME_MAX_PARTICIPANTS=12\n'
  ...
  printf 'ADX_CURRENT_GAME_TOKEN_ADDRESS=0x06D223D12774386A96D33863D9106A800e52BDeD\n'
  printf 'ADX_CURRENT_GAME_TOKEN_SYMBOL=mUSDC\n'
  printf 'ADX_CURRENT_GAME_TOKEN_DECIMALS=6\n'
  printf 'ADX_CURRENT_GAME_TOKEN_EIP712_NAME=Mock USD Coin\n'
  printf 'ADX_CURRENT_GAME_TOKEN_EIP712_VERSION=1\n'
  printf 'ADX_CURRENT_GAME_REQUIRED_CONFIRMATIONS=1\n'
  printf '\n'
