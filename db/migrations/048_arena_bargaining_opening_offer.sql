...
-- projection aligned with arena_core.candidate_validation. A buyer opening
-- offer may be below its hard reservation limit so a compatible pair can
-- counter once before the final accept/reject turn.
