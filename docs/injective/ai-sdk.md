...
- Official source: [https://docs.injective.network/developers-ai/ai-sdk](https://docs.injective.network/developers-ai/ai-sdk)
- Last source change: `2026-07-14`
...
`@injectivelabs/ainj` packages those pieces into a single install,
...
Install the Injective AI SDK globally with `npm`:
...
- [AI developers overview](./ai-developers.md)
- [Injective main MCP server](./mcp.md)
- [Injective documentation MCP server](./documentation-mcp.md)
- [Injective CLI agent skill](./injective-cli-skill.md)
- [Injective EVM Developer agent skill](./injective-evm-developer-skill.md)
- [Injective MCP Servers agent skill](./injective-mcp-servers-skill.md)
- [Injective Trading agent skills](./injective-trading-skills.md)
- [Injective x402](./x402.md)
